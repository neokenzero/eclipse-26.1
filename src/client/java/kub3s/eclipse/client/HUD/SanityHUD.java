...
public class SanityHUD {
    private static final Identifier ICONS = Identifier.fromNamespaceAndPath(Eclipse.MOD_ID, "textures/gui/sanity_icons.png");
    ...
    public static void render(GuiGraphicsExtractor guiGraphics) {
        ...
        if (minecraft.player != null) {
            SanityData sanityData = (SanityData)minecraft.player.getAttached(SanityAttachment.SANITY);
            if (sanityData != null) {
                ...
                for(int i = 0; i < 10; ++i) {
                    ...
                    guiGraphics.blit(RenderPipelines.GUI_TEXTURED, ICONS, x, top, (float)u, 0.0F, 9, 9, 16, 16, 48, 16);
                }
