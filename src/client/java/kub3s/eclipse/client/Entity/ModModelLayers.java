...
import kub3s.eclipse.client.Entity.Werewolf.WerewolfModel;
import kub3s.eclipse.client.Entity.Werewolf.WerewolfRenderer;
...
public class ModModelLayers {
    ...
    public static final ModelLayerLocation WEREWOLF = createMain("werewolf");
    ...
    public static void registerModelLayers() {
        ...
        ModelLayerRegistry.registerModelLayer(ModModelLayers.WEREWOLF, WerewolfModel::getTexturedModelData);
        EntityRendererRegistry.register(ModEntityTypes.WEREWOLF, WerewolfRenderer::new);
    }
}
